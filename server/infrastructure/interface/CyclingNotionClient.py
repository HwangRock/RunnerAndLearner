...
from server.infrastructure.domain.CyclingEntry import CyclingEntry

class CyclingNotionClient:
    def __init__(self):
        load_dotenv()
    ...
    def create_model(self):
        ...
        for row in rows:
            ...
            entry = CyclingEntry.change(props, extractor=self.extract_text)
            data.append(entry)
